...
QtObject {
    ...
    property string id_return_waveform_playback_position:    qsTrId("id_return_waveform_playback_position") + TranslationManager.translationChanged //CheckBox caption
